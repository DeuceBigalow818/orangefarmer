                      ...
                      <td style={A.td}>
                        {eligible ? (
                          <div style={{ display:"flex", gap:4, alignItems:"center" }}>
                            <button onClick={() => confirmDeposit(p)} disabled={txPending && txTarget===p.name} style={{ ...A.actBtn, opacity: txPending && txTarget===p.name ? 0.5 : 1 }}>{txPending && txTarget===p.name ? txStatus || "..." : p.stake>0?"Add More":"Deposit"}</button>
                            {p.stake > 0 && (
